...
const LeaveIcon: React.FC<IconProps> = ({className}) => {
    return (
        <svg className={className} viewBox="0 0 24 24" id="_24x24_On_Light_Session-Leave"
             data-name="24x24/On Light/Session-Leave" xmlns="http://www.w3.org/2000/svg" fill="#000000">
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                <path id="Shape"
                      ...
                      transform="translate(3.25 3.25)"></path>
            </g>
        </svg>
