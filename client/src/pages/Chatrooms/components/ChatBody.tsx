                        ...
                        selectedChannel === data.channel && (
                            data.sender !== username ? (
                                <div key={index} className="w-[70%] flex flex-col mt-4 mb-2">
                                    <label className="ml-5 text-xs mb-[3px] dark:text-[#a6b0cf] duration-100">
                                        {data.sender}
                                    </label>
                                    ...
                                    <label className="ml-5 mt[-2px] text-xs dark:text-[#a6b0cf] duration-100">
                                ...
                                <div key={index} className="flex justify-end mt-4 mb-2">
                                    <div className="w-[70%] justify-end">
                                        <div className="flex flex-wrap justify-end">
                                            <p className="overflow-hidden break-words my-2 mr-3 px-5 py-3 duration-100 rounded-t-xl rounded-l-xl bg-[#f5f7fb] dark:bg-[#36404a] text-black text-md dark:text-white">
                                                {data.message}
                                            </p>
                                        </div>
                                        <div className="flex justify-end mr-5 mt[-2px] ml-6">
                                            <label className="text-xs dark:text-[#a6b0cf] duration-100">
                                                {formatTime(data.createdAt)}
                                            </label>
                                        </div>
                                    </div>
